...
<table width="800" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333">
    <tr><td>
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <?php
                if (isset($_SESSION['cambio_importe'])) {
                    $arreglo_sesion = $_SESSION['cambio_importe'];
                    if($arreglo_sesion['id_liquidacion']==$id_liquidacion && ($arreglo_sesion['liq_mes']."-".$arreglo_sesion['liq_anio']==$periodo)) {
                        ?>
                        <tr>
                            <td colspan="3"><div align="center">Nuevo Precio: $<?php echo $arreglo_sesion['nuevo_precio']; ?></div></td>
                        </tr>
                        <?php
                    }
                }
...
<div style="position:absolute; width:400px; height:150px; z-index:1; left: 0px; top: 0px; 
     visibility:hidden;">
    <?php
    Grabar_Respuesta_Impresora($concepto, "recibo común", $monto, $id_liquidacion, $numero_recibo, "C");
    ?>
</div>

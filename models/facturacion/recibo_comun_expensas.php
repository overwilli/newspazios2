...
//$_REQUEST["nombre"]=  urldecode($_REQUEST["nombre"]);
...
$concepto = " pago de expensas por período: " . $periodo . " Código: " . $cod_inmueble;
...
<div style="position:absolute; width:400px; height:150px; z-index:1; left: 0px; top: 0px; 
     visibility:hidden;">
    <?php echo $concepto;echo $id_liquidacion;echo $monto;

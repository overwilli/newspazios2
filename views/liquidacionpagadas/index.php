...
$this->title = 'Preparar Liquidación a Propietarios';
...
<div class="liquidacionpagadas-index">
    ...
    <div class="row">
        <div class="col-md-10">
            <?= Html::a('Nueva Orden Pago', ['create'], ['class' => 'btn btn-success']) ?>
        </div>
    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => Html::activeDropDownList($searchModel, 'propietario_id', $arreglo_propietarios, 
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'form_liquidaciones_pago' => function ($url, $model) {
                        $url = \yii\helpers\Url::toRoute(['liquidacionpagadas/form-liquidaciones-ordenes',
                                    'orden_id' => $model->id,
                        ]);
                    ...
                    'comprobante_pdf' => function ($url, $model) {
                        if($model->estado=='Pagado'){
                            $url = \yii\helpers\Url::toRoute(['liquidacionpagadas/comprobante-propietario',
                             'orden_id' => $model->id,]);
                    ...
                    'comprobante_excel' => function ($url, $model) {
                        if($model->estado=='Pagado'){
                            $url = \yii\helpers\Url::toRoute(['liquidacionpagadas/comprobante-propietario-excel',
                            'orden_id' => $model->id,]);
